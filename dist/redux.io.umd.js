(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-redux'), require('hoist-non-react-statics'), require('lodash.pick')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-redux', 'hoist-non-react-statics', 'lodash.pick'], factory) :
	(factory((global.redux = global.redux || {}, global.redux.io = {}),global.React,global.reactRedux,global.hoistNonReactStatics,global.pick));
}(this, (function (exports,React,reactRedux,hoistNonReactStatics,pick) { 'use strict';
