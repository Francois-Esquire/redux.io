(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-redux'), require('hoist-non-react-statics')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-redux', 'hoist-non-react-statics'], factory) :
	(factory((global.redux = global.redux || {}, global.redux.io = {}),global.React,global.reactRedux,global.hoistNonReactStatics));
}(this, (function (exports,React,reactRedux,hoistNonReactStatics) { 'use strict';
...
function withSocket(uri, options) {
  ...
  function withSocketConnection(WrappedComponent, config) {
    ...
    const componentConnector = reactRedux.connectAdvanced(function (dispatch) {
      let io = null;
      let socket = null;
      let manager = null;
