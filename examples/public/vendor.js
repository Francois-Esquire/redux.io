var vendor = (function (exports) {
	...
	var withRouter = function withRouter(Component) {
	  var C = function C(props) {
	    ...
	    return react.createElement(Route, { render: function render(routeComponentProps) {
	        return react.createElement(Component, _extends$9({}, remainingProps, routeComponentProps, { ref: wrappedComponentRef }));
	      } });
	  };
	...
	*/
	    ...
	    var Connect = function (_Component) {
	      ...
	      Connect.prototype.render = function render() {
	        ...
	        if (selector.error) {
	          ...
	          return react_5(WrappedComponent, this.addExtraProps(selector.props));
	        }
	      };
	...
	function isPlainObject(obj) {
	  if ((typeof obj === 'undefined' ? 'undefined' : _typeof$4(obj)) !== 'object' || obj === null) return false;
	  ...
	  for (var i = 0; i < reducerKeys.length; i++) {
...

	    {
	      if (typeof reducers[key] === 'undefined') {
	        warning$5('No reducer provided for key "' + key + '"');
	      }
	    }
	...
	const redux = Redux;
	const ReactRedux = reactRedux;
	const ReactRouterDom = reactRouterDom;
